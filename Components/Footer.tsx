    ...
    <footer className="w-full grid place-items-center  text-white font-jetbrains py-[40px]">
      <div className="w-[1200px] flex flex-col gap-[29px]">
        ...
        <div className="w-full flex flex-row gap-[16px] items-stretch">
          <Special
            width="w-[588px] px-[22px] py-[10px] flex justify-between p-5 group items-center"
            hover="hover:translate-y-[-5px] hover:transition-all cursor-pointer"
          >
            ...
            <Image
              className="self-center rotate-0 group-hover:rotate-45 group-hover:transition-all"
              src={arrowIcon}
              alt="Arrow icon"
              width={20}
              height={20}
          ...
          <Special
            width=" flex items-center justify-center size-[129px]"
        ...
        <div className="author pt-[160px] flex justify-between">
          ...
          <p className="text-[#76BDBF] text-[13px] cursor-pointer font-jetbrains flex gap-2  items-center group">
            Buy me a coffee{" "}
            <svg
              width="11"
              height="11"
